...
> [!TIP]  
> Puede [ver y descargar el ejemplo de este artículo](https://github.com/dotnet/EntityFramework.Docs/tree/master/samples/core/Miscellaneous/SimpleLogging) en github.
...
> [!TIP]
> EF Core también se integra con [Microsoft. Extensions. Logging](/aspnet/core/fundamentals/logging), que requiere más configuración, pero suele ser más adecuado para el registro en aplicaciones de producción.
