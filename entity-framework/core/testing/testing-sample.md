...
> Consulte [pruebas con SQLite](xref:core/testing/sqlite) para obtener instrucciones sobre el uso de SQLite para realizar pruebas en memoria.
...
> Los enfoques para reducir esta sobrecarga se abordan en el [uso compartido de bases de datos entre pruebas](xref:core/testing/sharing-databases).
...
Estos se describen en el nivel conceptual del [código de prueba que usa EF Core](xref:core/testing/index).
