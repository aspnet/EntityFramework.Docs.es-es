...
<span data-ttu-id="96d98-176">La salida de la ejecución del código sería:</span><span class="sxs-lookup"><span data-stu-id="96d98-176">The output from running the code would be:</span></span>  
